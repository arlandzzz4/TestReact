...
const DashReportCard = () => {
    const {data: totalCnt} = useReportTotalCountQuery({targetCode: '', reportStatusCode: '01'});
    const {data: todayCnt} = useReportTodayCountQuery({targetCode: '', reportStatusCode: '01'});
