...
const ReportBoard = () => {
  ...
  const { data: postTotalCnt = 0 } = useReportTotalCountQuery({ targetCode: '01', reportStatusCode:'' })
  ...
  const { data: commentTotalCnt = 0 } = useReportTotalCountQuery({ targetCode: '02', reportStatusCode:'' })
